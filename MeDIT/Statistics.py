...
class BinaryClassification(object):
    ...
    def Run(self, pred, label, label_legend=('Negative', 'Positive')):
...
if __name__ == '__main__':
    ...
    # df = pd.read_csv(r'..\Document\DemoData\pred_label.csv')
    # pred = df['pred1'].values.squeeze().tolist()
